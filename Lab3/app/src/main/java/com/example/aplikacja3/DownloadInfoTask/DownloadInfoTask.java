package com.example.aplikacja3.DownloadInfoTask;
import android.os.AsyncTask;

import java.net.URL;
import javax.net.ssl.HttpsURLConnection;

public class DownloadInfoTask extends AsyncTask<String,Void,InfoWrapper> {
    public AsyncResponse delegate;

   public DownloadInfoTask(AsyncResponse delegate){
